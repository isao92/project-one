$(document).ready(function () {
    ...
    function searchLol(inputArtist) {
      ...
      $.ajax({
        ...
        for (var i = 0; i < 4; i++) {
          var div = $("<div>").addClass("col-md-3");
          var itemPrice = $("<p>").text("Your Price: " + newerResponse.findItemsByKeywordsResponse[0].searchResult[0].item[i].sellingStatus[0].currentPrice[0].__value__ + " USD").addClass("merch-price");
          var itemTax = $("<p>").text("  +TAX").addClass("merch-tax");
